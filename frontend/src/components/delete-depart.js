                ...
                <div>
                    <Box
                        ...
                        <Typography sx={{ marginLeft: '20px', color: '#ffffff' }}>
                            Delete department: {myData.meeting_name}
                        </Typography>
                    </Box>
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            Bạn chắc chắn muốn xóa bộ phận này không ? {myData.meeting_name}
                        </Box>

                        <Box sx={{
                            width: '30%', display: 'flex', justifyContent: 'flex-end', marginTop: '20px'
                        }}>
